...
const ENTRY_POINTS = ['./src/index-v1.6.ts']; // Same entry point for both Node.js and Browser
...
esbuild
  .build({
    ...
    bundle: true,
    outfile: './dist/index-v1.6.js',
    platform: 'browser',
    external: ['path', 'os', 'crypto'], // Adding 'crypto' here to exclude it from the browser bundle
    minify: PRODUCTION,
  })
